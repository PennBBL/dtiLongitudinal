...
model <- "~ s(AgeAtScan, k=4) + sex + race2+ gaf_raw + dti64Tsnr"
...
covariates <- "~ s(AgeAtScan, k=4) + sex + race2 + gaf_raw + dti64Tsnr "
...
cor.test(data.analysis$gaf_raw, data.analysis$mean_dti)
