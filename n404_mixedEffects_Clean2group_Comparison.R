...
covariates <- "~ s(AgeAtScan, k=4) + sex + race2 + dx_expanded_psyispro_t1_t2 + dti64Tsnr"
...
write.csv(gam_corr.fa, "/data/joy/BBL/projects/dtilongitudinal/output/dtiLongitudinal_Clean2Group_n404_fa.csv", row.names=F)
write.csv(gam_corr.md,"/data/joy/BBL/projects/dtilongitudinal/output/dtiLongitudinal_Clean2Group_n404_md.csv", row.names=F)
write.csv(gam_corr.rd, "/data/joy/BBL/projects/dtilongitudinal/output/dtiLongitudinal_Clean2Group_n404_rd.csv", row.names=F)
write.csv(gam_corr.ad, "/data/joy/BBL/projects/dtilongitudinal/output/dtiLongitudinal_Clean2Group_n404_ad.csv", row.names=F)
