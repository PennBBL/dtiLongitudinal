...
model <- "~ s(AgeAtScan, k=4) + sex + race2+ sevSipsMean + dti64Tsnr"
...
covariates <- "~ s(AgeAtScan, k=4) + sex + race2 + sevSipsMean + dti64Tsnr "
...
cor.test(data.analysis$sevSipsMean, data.analysis$mean_dti)
